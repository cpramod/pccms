...
IE: new-url-title"></i></h5>
                    ...
                    <div class="col-md-6">
                        ...
                        ?>
                        <?php echo form_multiselect('cats[]', $category, $sel_cat, ['class' => 'chosen-select-no-single']) ?>
                ...
                <div class="row with-forms">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="edit-profile-photo">
                            <?php echo $featured_image ? external_image(getFileUrl($featured_image)) : img('user-avatar.jpg'); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="checkboxes in-row margin-bottom-20">
                            <input type="radio" id="pub_yes" name="status" value="published" <?php echo $status=='published'?'checked':'';?>>
                            <label for="pub_yes">Yes</label>
                            <input type="radio" id="pub_no" name="status" value="draft" <?php echo $status == 'draft' ? 'checked' : ''; ?>>
                    ...
                    <div class="col-md-12">
                        <div id="meta">
                            ...
                            foreach ($metas as $meta) {
                                ...
                                <div class="row" style="margin-bottom:20px;">
                                    <div class="col-sm-5">
                                        <input type='text' readonly="readonly" name='key[]' placeholder='Name' class='form-control m-input' value='<?php echo $meta->meta_key; ?>'>
                                    </div>
                                    <div class="col-sm-5">
                                        <input type='text' name='value[]' placeholder='Value' class='form-control m-input' value='<?php echo $meta->meta_value; ?>'>
                                    </div>
                                    <div class="col-sm-2">
                                        <a href="javascript:" class="btn btn-danger remove"><i class="fa fa-minus"></i></a>
                                    </div>
                                </div>
                            <?php
            ...
            <div class="add-listing-section margin-top-45">
                ...
                <div class="row with-forms">
                    <div class="col-md-12">
                        ...
                        <input class="search-field" type="text" name="meta_title" value="<?php echo set_value('meta_title', $meta_title); ?>" />
                    </div>
                </div>
                ...
                <div class="form">
                    ...
                    <textarea class="" name="meta_description" cols="40" rows="3" id="meta_description" spellcheck="true">
                        <?php echo set_value('meta_description', $meta_description); ?>
                    </textarea>
                </div>
