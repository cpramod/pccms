            ...
            <div class="widget-body">
                <form class="form-horizontal" action="<?php echo current_url(); ?>" method="POST">
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="slug" value="<?php echo set_value('slug',$slug); ?>">
                        </div>
                    </div>
                    <div class="form-group row d-flex align-items-center mb-5">
                        <label class="col-lg-3 form-control-label">Description</label>
                        <div class="col-lg-9">
                            <textarea name="description" class="form-control summernote"><?php echo set_value('description',$description); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row d-flex align-items-center mb-5">
                        <label class="col-lg-3 form-control-label">Icon</label>
                        <div class="col-lg-9">
                            <input type="text" name="icon" value="<?php echo set_value('icon',$icon); ?>" class="form-control">
                        </div>
                    </div>
