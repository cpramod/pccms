...
//            );
    ...
    public function edit_user($id)
    {
        ...
        if($this->input->post('team_size')){
            $this->form_validation->set_rules('team_size','Team Size','integer');
        }
        ...
        if (isset($_POST) && !empty($_POST))
        {
            ...
            if ($this->form_validation->run() === TRUE)
            {
                ...
                if($this->input->post('avatar')){
                    ...
                    $upload_id = $this->profile_m->insert(config('tbl_upload'),array('title'=>$filename,'link'=>$filename));
