                ...
                <article class="post post-large blog-single-post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="post-meta">
                            ...
                            <span><i class="fas fa-calendar-alt"></i> Created: <?php echo date('Y-m-d H:i',strtotime($post['created_datetime'])); ?> </span>
                            <?php if ($post['modified_datetime']) : ?>
                                <span><i class="fas fa-calendar-alt"></i> Updated: <?php echo date('Y-m-d H:i',strtotime($post['modified_datetime'])); ?> </span>
                            <?php endif; ?>
                        </div>
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="img-thumbnail d-none d-sm-block">
                                            <img class="avatar" alt="" src="<?php echo $comment->avatar?getFileUrl($comment->avatar): 'http://www.gravatar.com/avatar/00000000000000000000000000000000?d=mm&s=70'; ?>">
                                        </div>
