                ...
                <div class="add-listing-section">
                    ...
                    <div class="row with-forms">
                        <div class="col-md-12">
                            ...
                            <input class="search-field" type="text" name="name" value="<?php echo set_value('name', $name); ?>" />
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="chosen-select-no-single" name="parent" >
                                    ...
                                    foreach ($categories as $category) {
                                        ...
                                        if ($category['id'] != $id) :
                                        ?>
                                        <option <?php echo $category['id'] == $parent ? 'selected' : ''; ?> value="<?php echo $category['id']; ?>"><?php echo $category['name']; ?></option>
                                        <?php
                                        endif;
                                    } ?>	
