...
IE: new-url-title"></i></h5>
                        ...
                        <div class="col-md-6">
                            ...
                            <?php $parent_data = array('' => 'Select Category');
                            foreach ($categories as $category) {
                                $parent_data[$category->id] = $category->title;
                            }
                            ?>
                        <?php echo form_dropdown('parent', $parent_data, $parent, 'class="chosen-select-no-single"'); ?>
